...
>
	<Card.Root class="@container/card">
		<Card.Header>
			...
			<Card.Title class="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">$1,250.00</Card.Title>
			<Card.Action>
	...
	<Card.Root class="@container/card">
		<Card.Header>
			...
			<Card.Title class="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">1,234</Card.Title>
			<Card.Action>
				<Badge variant="outline">
					<TrendingDownIcon />
					-20%
	...
	<Card.Root class="@container/card">
		<Card.Header>
			...
			<Card.Title class="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">45,678</Card.Title>
			<Card.Action>
				<Badge variant="outline">
					<TrendingUpIcon />
					+12.5%
	...
	<Card.Root class="@container/card">
		<Card.Header>
			...
			<Card.Title class="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">4.5%</Card.Title>
			<Card.Action>
				<Badge variant="outline">
					<TrendingUpIcon />
					+4.5%
